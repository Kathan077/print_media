...
const masonryItems = [
  ...
  { id: 5, img: "https://images.unsplash.com/photo-1563298723-dcfebaa392e3?auto=format&fit=crop&q=80&w=800", title: "Pantone Color Match", category: "Color Science" },
  { id: 6, img: "https://images.unsplash.com/photo-1541746972662-841f486d3b37?auto=format&fit=crop&q=80&w=800", title: "Die-Cut Precision", category: "Creative Prints" }
];
...
const horizonItems = [
  ...
  { id: 3, img: "https://images.unsplash.com/photo-1563298723-dcfebaa392e3?auto=format&fit=crop&q=80&w=1200", title: "Pantone Perfect" },
  { id: 4, img: "https://images.unsplash.com/photo-1541746972662-841f486d3b37?auto=format&fit=crop&q=80&w=1200", title: "Die-Cut Edges" }
];
...
const GalleryPage = () => {
  ...
  useEffect(() => {
    ...
    mm.add("(min-width: 769px)", () => {
        ...
        // Desktop Horizontal Scroll Pin Section
        const hWrap = document.querySelector(".gal-horizon-wrap");
        if (hWrap) {
